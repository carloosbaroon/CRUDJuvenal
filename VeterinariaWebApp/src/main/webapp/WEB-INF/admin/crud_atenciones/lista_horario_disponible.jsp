...
<table border="1">
	<tr>
       ...
       <td><b>Disponible despues</b></td>
       <td><b>Seleccionar</b></td>
    </tr>

<s:iterator value="buffer_horario_disponible" status="i">
	<tr>
		<td><s:property value="id_sala"/></td>
		<td><s:property value="hora_final"/></td>
		<td>
			<s:url action="goto_reservar_sala" var="url_registrar_atencion">
       			<s:param name = "consulta.fecha_consulta">${datesyst}</s:param>
       			<s:param name = "consulta.hora_inicial">${hora_final}</s:param>
