...
<html>
	<head>
	<title>Administraci�n Pacientes</title>
...
<div class="banner-head">
	<div class="banner-1"> </div>
		<div class="container">
			<br>
			<h1>Administraci�n Pacientes</h1>	
		</div>
</div>
<!--content-->
<div class="about">
		...
		<div class="container">
			<div class="why-top-top">
				...
				<div class="col-sm-4 top-content">
						...
						<h4><a href="${alta_owner}">Dar de Alta Due�o</a></h4>	
						<h4><a href="${alta_paciente}">Dar de Alta Paciente</a></h4>	
						<h4><a href="${modificar_owner}">Modificar Due�o</a></h4>
